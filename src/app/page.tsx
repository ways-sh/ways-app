...
const navItems = [
  { label: ' ', href: 'https://github.com/ways-sh', icon: GitHubLogoIcon },
  { label: '  ', href: 'https://x.com/ways_sh', icon: RiTwitterXFill },
];
...
const Header = ({ handleLogin }: { handleLogin: () => void }) => {
  ...
  return (
    <BlurFade delay={0.1} className="relative z-50">
      <header className="fixed left-0 right-0 top-2">
        <div className="mx-auto max-w-6xl px-4 py-4">
          <div className="rounded-xl border border-border/50 bg-muted/70 shadow-lg backdrop-blur-md">
            <div className="flex items-center justify-between px-4 py-2">
              ...
              <nav className="hidden md:ml-auto md:mr-2 md:flex">
                {navItems.map((item) => {
      ...
      <div className="relative mx-auto max-w-screen-xl px-6 pb-6 pt-12 text-center md:pb-8 md:pt-16">
        ...
        <div className="mx-auto max-w-3xl">
          <BlurFade delay={0.3} className="pointer-events-none select-none">
              <div className="flex justify-center mb-12">
                <Image src="/W_logo.png" alt="Product" width={256} height={256} className='p-4'/>
              </div>
          </BlurFade>
        </div>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <BlurFade delay={0.3} className="pointer-events-none select-none">
            ...
            {/* <div className="inline-flex items-center rounded-full border border-primary/20 bg-muted/80 px-4 py-2 shadow-lg backdrop-blur-sm">
              <span className="text-sm font-medium text-primary">
                ✨ Built on Sonic DeFAI Hackathon
              </span>
            </div> */}

            <h1 className="mt-10 text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">
              The {' '}
              <AnimatedShinyText className="inline">
                <span>Ultimate AI Copilot</span>
              </AnimatedShinyText>{' '}
              for Sonic Chain
            </h1>

            <p className="mt-4 text-lg text-muted-foreground">
              Supercharge your Sonic journey with AI-driven support
            </p>
          </BlurFade>
...
const features = [
  {
    ...
    description:
      "Harness the power of the world's most advanced AI models, including Claude 3.5-Sonnet and GPT-4o, to intelligently analyze your Sonic transactions in real-time, providing data-driven insights and seamless automated actions.",
  ...
  },
  {
    ...
    description:
      'Experience ultra-efficient, frictionless transactions powered by our deep Sonic integration. Enjoy smooth, rapid execution without the need for compromise.',
  ...
  },
  {
    ...
    description:
      "Effortlessly connect with the full spectrum of Sonic's protocols and services. Our platform is designed for seamless AI-powered collaboration, ensuring full synergy with the ecosystem.",
  ...
  },
  {
    ...
    description:
      'Built with transparency and collaboration in mind. Our full-stack application is completely open source, community-driven, and welcomes contributions from developers worldwide to shape the future of Sonic AI tools.',
    className: 'col-span-1 sm:col-span-3 lg:col-span-1',
    background: (
      <div className="absolute inset-0 flex items-center justify-center opacity-20">
