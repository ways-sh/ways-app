...
// EVM
import { dexscreenerTools } from './evm/dexscreener';
import { sonicTools } from './evm/sonic';
import { mobulaTools } from './evm/mobula';
...
- If you have an EVM-like addresses in your response, post it with link to explorer: https://sonicscan.org/address/{address_here}
- If you have a dexId in your response, format it for human readability. Example: "shadow-exchange:Shadow X, wagmi:WAGMI"

Common knowledge:
- { token: S, description: The native token of Sonic, twitter: @soniclabs, website: https://soniclabs.com, address: 0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38 }
- { user: Andre Cronje, description: Co-Founder of Sonic , twitter: @AndreCronjeTech, telegram: andrecronje }\
...
> = {
  ...
  sonicTools: {
    tools: ['sonicTools'],
    description:
      'Tools for interacting with Sonic blockchain: token swaps, transfers, querying Sonic (native currency) balance, querying token balance (by token contract address)',
  },
  mobulaTools: {
    tools: ['mobulaTools'],
    description:
      'Tools for querying Sonic price and getting wallet portfolio',
  },
  defiTools: {
    tools: ['dexscreenerTools'],
    description:
      'Tools for searching token information and details, querying market data like price, trading volume, trending tokens',
  },
  webTools: {
    tools: ['jinaTools'],
    description:
  ...
  //   tools: ['birdeyeTools'],
  //   description:
  //     'Tools for analyzing and tracking traders and trades on Sonic DEXes.',
  // },
  // financeTools: {
  //   tools: ['definedTools'],
  //   description:
  ...
  //   tools: ['cookieTools'],
  //   description:
  //     'Tools for retrieving information about Sonic AI Agents, and Tweets related to Agents.',
  // },
  // bundleTools: {
  //   tools: ['bundleTools'],
  //   description:
...
You are Ways, an AI assistant specialized in Sonic blockchain and DeFi operations.
